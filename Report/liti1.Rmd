...
> <p style = 'text-align: justify;'>
Verificar a existência de valores omissos *NA's* no *DataSet* :
</p>

```{r NAs, message = FALSE, warning = FALSE}
incomplete = sum(is.na(exp))
complete = sum(complete.cases(exp))
incomplete+complete
```
> <p style = 'text-align: justify;'>
Com a execução do comando anterior verificamos que existem um total de 94080 valores omissos no nosso *DataSet*.
</p>
