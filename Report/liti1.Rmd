...
```
> <p style = 'text-align: justify;'>
O código acima apresentado é resposável pela remoção dos valores omissos e normalização do *ExpressionSet*, a ser utilizado nos restantes passos, como é possivel verificar através dos valores da média e desvido padrão, assimcomo o número de valores omissos no *output* do último comando executado.
</p>
...
Table: **Tabela 2928936825983** -  Os 25 Genes com maior expressão diferencial no teste estatístico entre os grupos Controlo e Lítio após 1 mês de tratamento.
...
Table: **Tabela 35375573895** -  Tabela com os 15 termos GO mais associados aos genes diferencialmente expressos no que diz respeito à distinção das amostras de controlo e lítio ao fim de 1 mês de tratamento.
