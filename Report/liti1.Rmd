...
incomplete = sum(!complete.cases(exp))
incomplete
complete = sum(complete.cases(exp))
complete
incomplete+complete
```
> <p style = 'text-align: justify;'>
Com a execução dos comandos anteriores verificamos que existem um total de 784 registos incompletos *DataSet* e 47323 registos completos, fazendo assim um total de 48107, como esperado.
</p>
