...
> <p style = 'text-align: justify;'> 
Aplicando o método de *k-vizinhos mais próximos* ao tipo de tratamento, obteve-se um modelo com precisão de aproximadamente **89%** para o tratamento controlo e **80%** para o  tratamento com adição de lítio, o que nos indica que o modelo permite fazer previsões com uma precisão bastante razoável para ambos os casos.
</p>
